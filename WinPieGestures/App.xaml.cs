...
public partial class App : Application
{
	...
	protected override void OnStartup(StartupEventArgs e)
	{
		...
		base.OnStartup(e);
		AppLogger.LogInfo($"=== StarPie v1.7.0 Starting (OS: {Environment.OSVersion}, .NET: {Environment.Version}, 64bit: {Environment.Is64BitProcess}, Elevated: {ConfigManager.IsElevated()}) ===");
